...
<div class="container">
    ...
    <form action="#" class="form-horizontal">
        <div class="form-group">
            <label for="exmpleInput" class="col-sm-4 control-label">Input Label</label>
            <div class="col-sm-8">
                <input type="text" id="exmpleInput" class="form-control" placeholder="Placeholder text">
                <span class="input-icon fui-info"></span>
            </div>
        </div>
    </form>
</div><!-- /.container -->
